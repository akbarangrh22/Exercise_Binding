...
namespace Exercise_Binding {
    ...
    public partial class AdventureWorksDataSet2 : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeeRow AddEmployeeRow(string NationalIDNumber, EmployeeRow parentEmployeeRowByFK_Employee_Employee_ManagerID) {
                ...
                if ((parentEmployeeRowByFK_Employee_Employee_ManagerID != null)) {
                    columnValuesArray[2] = parentEmployeeRowByFK_Employee_Employee_ManagerID[0];
                }
...
namespace Exercise_Binding.AdventureWorksDataSet2TableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [HumanResources].[Employee] WHERE (([EmployeeID] = @Original_Employee" +
                "ID) AND ([NationalIDNumber] = @Original_NationalIDNumber) AND ((@IsNull_ManagerI" +
                "D = 1 AND [ManagerID] IS NULL) OR ([ManagerID] = @Original_ManagerID)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [HumanResources].[Employee] SET [NationalIDNumber] = @NationalIDNumber, [ManagerID] = @ManagerID WHERE (([EmployeeID] = @Original_EmployeeID) AND ([NationalIDNumber] = @Original_NationalIDNumber) AND ((@IsNull_ManagerID = 1 AND [ManagerID] IS NULL) OR ([ManagerID] = @Original_ManagerID)));
SELECT EmployeeID, NationalIDNumber, ManagerID FROM HumanResources.Employee WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Exercise_Binding.Properties.Settings.Default.AdventureWorksConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, NationalIDNumber, ManagerID FROM HumanResources.Employee";
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_NationalIDNumber, global::System.Nullable<int> Original_ManagerID) {
        ...
        public virtual int Update(string NationalIDNumber, global::System.Nullable<int> ManagerID, int Original_EmployeeID, string Original_NationalIDNumber, global::System.Nullable<int> Original_ManagerID, int EmployeeID) {
            ...
            if ((Original_NationalIDNumber == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(Original_NationalIDNumber));
            }
            if ((Original_ManagerID.HasValue == true)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string NationalIDNumber, global::System.Nullable<int> ManagerID, int Original_EmployeeID, string Original_NationalIDNumber, global::System.Nullable<int> Original_ManagerID) {
            return this.Update(NationalIDNumber, ManagerID, Original_EmployeeID, Original_NationalIDNumber, Original_ManagerID, Original_EmployeeID);
        }
    }
